...
values('规范用语监管事项关联', '1224', '1', 'normativematterbind', 'system/normativematterbind/index', 1, 0, 'C', '0', '0', 'system:normativematterbind:list', '#', 'admin', sysdate(), '', null, '规范用语监管事项关联菜单');
