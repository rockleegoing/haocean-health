package com.ruoyi.code.handler
...
object XHandler {
     ...
     */
    fun init(callback: Handler.Callback?): XHandler {
     ...
     */
    fun init(looper: Looper): XHandler {
        mCallback = null
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    fun init(looper: Looper, callback: Handler.Callback): XHandler {
        mCallback = callback
